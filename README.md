...
# Optional/local extensions and workflows
atuin --version
claude --version
```
...
brew install gh universal-ctags ast-grep ankitpokhrel/jira-cli/jira-cli atuin
...
# - fff-mcp: provided by @ff-labs/pi-fff / local ~/.local/bin install
